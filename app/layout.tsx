...
export const metadata: Metadata = {
  ...
  description: "Découvrez l'art du Kobido, un soin du visage d'exception",
  themeColor: "#ffffff",
...
export default function RootLayout({ children }: IProps) {
  return (
    <html lang="fr" className={`${adventPro.variable} text-lg`}>
      <head>
      ...
      <body className="font-advent-pro text-lg">
        <Provider>
