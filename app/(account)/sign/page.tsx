...
export default function Sign() {
  ...
  return (
    <div className="flex h-screen items-center justify-center gap-4 md:justify-between">
      ...
      {isMobile !== true ? (
        <div
          className="z-1 text-card-foreground formWidth ml-8 h-max rounded-lg border border-gray-800 bg-[#79018c] bg-opacity-30 bg-clip-padding p-5 shadow-md backdrop-blur-sm backdrop-filter md:w-1/3"
          data-v0-t="card"
        >
          ...
          <div className="flex h-full items-center justify-center">
            <div className="space-y-2 pl-6 pr-6 pt-6">
        ...
        <div
          className="z-1 text-card-foreground formWidth h-max rounded-lg border-gray-800 bg-[#79018c] bg-opacity-30 bg-clip-padding p-5 shadow-md backdrop-blur-sm backdrop-filter md:w-1/3"
          data-v0-t="card"
        >
          <div className="w-full text-center">
            <Button
