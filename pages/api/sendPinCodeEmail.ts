  ...
  if (req.method === 'POST') {
    ...
    try {
      ...
      const mailOptions = {
        ...
        html: `<h1>Cher(e) client(e),</h1><br/><p>Veuillez trouver le code PIN ci-après à remplir pour réinitialiser votre mot de passe: ${userPinCode}</p><br/><p>De la même manière, veuillez noter que celui-ci devra être conservé car sera nécessaire pour accéder à certains widgets et fonctionnalités de Unigate.</p>`,
      };
