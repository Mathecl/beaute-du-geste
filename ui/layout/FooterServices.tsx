...
export default function FooterServices() {
  ...
  return (
    <>
      {(userRole === 'consumer' || userRole === '' || userRole === null) &&
              ...
              <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
                <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                      <a href="/activateaccount" className="hover:underline">
                        Activer son compte
                      </a>
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <div>
                    <ul className="text-gray-600 dark:text-gray-400">
                      <li>
                        <Link href={`/uniblog`} className="hover:underline">
                          Uniblog
                        </Link>
                      </li>
                      <li>
                        <Link
                          href={`/client/${userCompany}`}
                      ...
                      <li>
                        <Link
                          href={`/client/${userCompany}/unismart`}
                          className="hover:underline"
                        >
                          Unismart
                        </Link>
                      ...
                      <li>
                        <Link
                          href={`/client/${userCompany}/unimeet`}
                          className="hover:underline"
                        >
                          Unimeet
                        </Link>
                      ...
                      <li>
                        <Link
                          href={`/client/${userCompany}/unidmin`}
                          className="hover:underline"
                        >
                          Unidmin
                        </Link>
                      ...
                      {/* <li>
                    <Link href={`/unibiz/${userCompany}`} className="hover:underline">
                      Unibiz
                    </Link>
                  </li> */}
                    </ul>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400">
                    <li>
                      <a href="/cgu" className="hover:underline">
                        ...
                        d'utilisations et politique <br /> de confidentialité
                      </a>
                    </li>
                  </ul>
                </div>
