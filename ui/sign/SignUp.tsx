                  ...
                  <div className="grid">
                    <span className="p-float-label">
                      ...
                      <small id="username-help">
                        Ce code PIN est à conserver car vous sera
                        potentiellement demander ultérieurement à l'utilisation
                        de certains widgets et fonctionnalités
                      </small>
                    </span>
                  </div>
                </div>
        ...
        >
          ...
          <div className="text-sm">
            <p className="mt-10 text-center text-sm text-white">
              Vous souhaitez lire les CGU ainsi que la politique de
              confidentialité ?&nbsp;
              <Link
                href="/cgu"
